...
public class GetIncomeStatusAPI {
    ...
    public void requestService() throws JsonProcessingException {
        ...
        response = Unirest.post("https://uat.ssa.gov.ae/ApplicationWS_API/rest/SocialSupportSupportRequest/GetIncomeStatus")
...
//        }
        ...
        GetIncomeStatusModel member= new GetIncomeStatusModel();
        member.emiratesId ="";
        member.incomeType="";
//        System.out.println(toJson(member));
    ...
    public Root getresponse(GetIncomeStatusAPI submitApplicationService) throws JsonProcessingException {
