...
public class AuditorsManagementPage extends Base {
    ...
    private By auditorsManagement = By.id("DCDAgentPortalTheme_wt290_block_wtMenu_DCDAgentPortalTheme_wt82_block_RichWidgets_wt128_block_wtMenuItem_wt21");
    private By selectspecid = By.id("DCDAgentPortalTheme_wt15_block_wtMainContent_WebPatterns_wt44_block_wtContent_wtStatus");
