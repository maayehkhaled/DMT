...
public class MobileContactsPage extends MobileBase {
    ...
    private final By addContactButton = By.xpath("//android.widget.Button[@content-desc=\"Add Contact\"]");
    private final By contactName = By.id("com.example.android.contactmanager:id/contactNameEditText");
    private final By contactPhone = By.id("com.example.android.contactmanager:id/contactPhoneEditText");
    private final By contactEmail = By.id("com.example.android.contactmanager:id/contactEmailEditText");

    private final By saveButton = By.id("com.example.android.contactmanager:id/contactSaveButton");
