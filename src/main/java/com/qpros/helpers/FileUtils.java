...
public class FileUtils {
    public  static LogManager logManager= new LogManager(FileUtils.class.getSimpleName());
    ...
    public static void createFile(File file, final String fileName, final String content) {
        ...
        try {
            ...
            if (!file.exists()) {
                ...
                if (created) {
                    logManager.DEBUG(String.format("Created file file named='%s'", fileName));
                    return;
                }
            }

        } catch (Exception e) {
            logManager.DEBUG(String.format("Unable to create file named='%s'", fileName));
        }
    ...
    public static List<String> readFile(File file, final String fileName) {
        ...
        try {
            ...
            logManager.DEBUG(String.format("Unable to read file named='%s'", fileName));
        }
        return lines;
    }
    ...
    public static List<String> readFile(File file) {
        ...
        try {
            ...
            logManager.DEBUG(String.format("Unable to read file named='%s'", file.getName()));
        }
        return lines;
    }
    ...
    public static void copyFile(final String sourceFileName, final String targetFileName) {
        ...
        try {
            ...
            if (targetFile.exists()) {
                logManager.DEBUG(String.format("Source File named='%s' copied to Destination File named='%s'", sourceFileName, targetFileName));
            }
        } catch (Exception e) {
            logManager.DEBUG(String.format("Unable to copy file named='%s'", sourceFileName));
        }
    ...
    public static void prependToFile(final String fileName, final String contentToPrepend, final boolean prependOnNewLine) {
        ...
        try {
            if (sourceFile.exists()) {
                ...
                logManager.DEBUG(String.format("File named='%s' prepend with content", sourceFile.getName()));
            }
        } catch (Exception e) {
            logManager.DEBUG(String.format("Unable to prepend file named='%s'", fileName));
        }
    }
    ...
    public static void appendToFile(final String fileName, final String contentToAppend) {
        ...
        try {
            if (sourceFile.exists()) {
                ...
                logManager.DEBUG(String.format("File named='%s' appended with content", sourceFile.getName()));
            }
        } catch (Exception e) {
            logManager.DEBUG(String.format("Unable to append file named='%s'", fileName));
        }
    }
    ...
    public static void deleteFile(File file, final String fileName) {
        ...
        try {
            if (file.exists()) {
                ...
                if (!file.exists()) {
                    logManager.DEBUG(String.format("Delete file named='%s'", fileName));
                    return;
                } else {
                    logManager.DEBUG(String.format("Unable to delete file named='%s'", fileName));
                }
