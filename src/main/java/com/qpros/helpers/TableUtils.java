...
import com.qpros.common.WebElementType;
...
public class TableUtils {
    ...
    public  static LogManager logManager= new LogManager(TableUtils.class.getSimpleName());
    ...
    public static String getWebElementTableText(final WebElement tableElement, int rowIndex, final String columnIdentifier) {
        ...
        try {
            ...
            logManager.DEBUG("exception='%s'", e);
        } catch (Exception e) {
            logManager.DEBUG("exception='%s'", e);
        }
    ...
    public static int getColumnIndexBasedOnColumnIdentifier(final WebElement tableElement, final String columnIdentifier) {
        ...
        try {
           ...
           logManager.DEBUG(String.format("Column='%s' not found", columnIdentifier), e);
            return columnIndex;
        }
        return columnIndex;
    }
    ...
    public static int getWebElementTableRowCount(final WebElement tableElement) {
        ...
        try {
            ...
            logManager.DEBUG( "Unable to find table element text for table, Exception='%s'", e);
            rowCount = 0;
        }
        return rowCount;
    }
    ...
    public static List<String> readAllColumnValues(final WebElement tableElement, final String columnIdentifier, int rowCount) {
        ...
        try {
            ...
            logManager.DEBUG(String.format("Unable to read column=%s", columnIdentifier), e);
