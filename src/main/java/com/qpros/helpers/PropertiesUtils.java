...
public class PropertiesUtils {
    public  static LogManager logManager= new LogManager(PropertiesUtils.class.getSimpleName());
    ...
    public static List<String> readResourceFile(final String fileName) {
        ...
        try {
            ...
            logManager.DEBUG(String.format("Unable to read file='%s' due to exception='%s'", fileName, e.getMessage()));
        }
        return null;
    }
    ...
    public static File getFileFromResources(final String fileName) {
        ...
        try {
            ...
            logManager.DEBUG(String.format("Unable to find file='%s' due to exception='%s'", fileName, e.getMessage()));
        }
        return null;
    }
    ...
    public static Properties getPropertiesFromPropertyFile(final String propertiesFileName) {
        ...
        try {
            ...
            logManager.DEBUG(String.format("Unable to get properties file='%s' due to exception='%s'", propertiesFileName, e.getMessage()));
            return props;
        }
        return props;
    }
