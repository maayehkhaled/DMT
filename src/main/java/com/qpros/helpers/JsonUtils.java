...
public class JsonUtils {
    ...
    public  static LogManager logManager= new LogManager(JsonUtils.class.getSimpleName());
    ...
    public static String convertMapToQueryParameters(Map<String, String> pathParameter) {
        ...
        decoratedQueryUrl = StringUtils.removeEnd(decoratedQueryUrl, "&");
    ...
    public static JSONObject convertObjectToJson(Object sourceObject) {
        ...
        try {
            ...
            logManager.DEBUG(String.format("Failed to convert POJO to JSON due to exception=%s", e.getMessage()));
        }
        return hydratedJson;
    }
