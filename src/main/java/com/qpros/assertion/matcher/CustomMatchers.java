package com.qpros.assertion.matcher;
...
public class CustomMatchers {
    ...
    public static class CollectionContainsMatcher extends BaseMatcher {
        ...
        public CollectionContainsMatcher(Object expected) {
            ...
            if (expected instanceof String) {
                if (StringUtils.containsAny(expected.toString(), "()".toCharArray())) {
                    ...
                    expected = StringUtils.replace(expected.toString(), ")", "\\)");
                    pattern = Pattern.compile(LogManager.formatMessage(COLLECTION_WITH_PARENTHESIS_CONTAINS_REGEX, expected));
                    return;
                }

            }
            pattern = Pattern.compile(LogManager.formatMessage(COLLECTION_CONTAINS_REGEX, expected));
        }
        ...
        public void describeTo(Description description) {
            ...
            description.appendText(LogManager.formatMessage("expected='%s'", expected));
        }
    }
