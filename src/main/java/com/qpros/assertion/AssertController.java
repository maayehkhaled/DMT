...
public class AssertController extends Assertion {
    public LogManager logManager = new LogManager(AssertController.class.getSimpleName());
     ...
     */
    @Override public void executeAssert(IAssert assertCommand) {
        try {
     ...
     * @param assertCommand assertion command to execute
     */
    @Override protected void doAssert(IAssert assertCommand) {
     ...
     */
    @Override public void onAssertSuccess(IAssert assertCommand) {
     ...
     */
    @Override public void onAssertFailure(IAssert assertCommand, AssertionError ex) {
     ...
     */
    @AfterMethod(alwaysRun = true) public void assertionTearDown() {
        if (!verificationFailuresMap.isEmpty()) {
            ITestResult result = Reporter.getCurrentTestResult();
            logManager.DEBUG(String.format("Number of Failures: %s", verificationFailuresMap.size()));
