		...
		<div class='view-summary'>
			<ul id='test-collection' class='test-collection'>
				<div class='test-heading'>
					<span class='strong test-name'>Test ID # - Test Name</span>
					<span class='strong test-time'>Test Start Time</span>
					<span class='strong test-status right'>Test Status</span>
				</div>
				<#list report.testList as test>
				...
				<li class='test displayed ${ hasChildrenClass } ${ test.status }' status='${ test.status }' bdd='${ isBdd?string }' test-id='${ test.getID() } active'>
					<div class='test-heading'>
						<span class='test-name'></span>
						<span class='test-name'>${test?counter?string["000"]} - ${test.name}</span>
