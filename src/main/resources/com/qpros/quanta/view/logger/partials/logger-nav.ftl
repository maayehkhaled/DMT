<div id="aside" class="app-aside fade box-shadow-x folded dark">
	<div class="sidenav modal-dialog dk">
		<div class="navbar">
			...
			<span class="d-inline small"><img src="https://cdn.jsdelivr.net/gh/maayehkhaled/quanat-framework/reportlogo.png"></span>
			</a>
		</div>
			...
			<div class="nav-fold">
				...
				<div class="hidden-folded flex p-2-3 bg">
					<div class="d-flex p-1">
						<a href="http://github.com/Quanta-framework/quanta" class="flex text-nowrap"><i class="fa fa-github"></i></a>
						<a href="http://quanta.com" class="px-2"><i class="fa fa-book"></i></a>
					</div>
				</div>
			</div>
		</div>
