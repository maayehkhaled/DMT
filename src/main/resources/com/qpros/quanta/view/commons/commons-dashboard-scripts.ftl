			        ...
			        type: 'doughnut',
			            data: {
			                datasets: [{
			                    borderColor: 'transparent',
			                    data: [
			                    	${report.reportStatusStats.childCountPass?c}, ${report.reportStatusStats.childCountFail?c}
			                    ],
			                    backgroundColor: [
			                        "#00af00", "#F7464A"
			                    ]
			        ...
			        type: 'doughnut',
			            data: {
			                datasets: [{
			                    borderColor: 'transparent',
			                    data: [
			                    	${report.reportStatusStats.grandChildCountPass?c}, ${report.reportStatusStats.grandChildCountFail?c}
			                    ],
			                    backgroundColor: [
			                        "#00af00", "#F7464A"
			                    ]
