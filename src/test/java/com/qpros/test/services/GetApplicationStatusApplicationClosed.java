...
public class GetApplicationStatusApplicationClosed extends Base {
    ...
    public void getApplicationStatusApplicationClosed() throws JsonProcessingException {
        getData();
        getApplicationStatusClosed();
        ...
        public void getData() {
            ...
            try {
                ...
                String [] nextLine;
                while((nextLine= csvReader.readNext())!=null&& count<=66){
                    count++;
        ...
        public void getApplicationStatusClosed() throws JsonProcessingException {
        logManager.STEP("GetApplicationStatusApplicationClosed","");
