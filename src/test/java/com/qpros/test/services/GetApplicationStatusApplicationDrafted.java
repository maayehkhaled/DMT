...
public class GetApplicationStatusApplicationDrafted extends Base {
    ...
    @Test(description = "GetApplicationStatusApplicationDrafted", priority = 1,
            retryAnalyzer = com.qpros.helpers.RetryAnalyzer.class, groups = {"API"})
    public void getApplicationStatusApplicationDrafted() throws JsonProcessingException {
        getData();
        getApplicationStatusDrafted();
        ...
        public void getData() {
            ...
            try {
                ...
                String [] nextLine;
                while((nextLine= csvReader.readNext())!=null&& count<=68){
                    count++;
        ...
        public void getApplicationStatusDrafted() throws JsonProcessingException {
        logManager.STEP("GetApplicationStatusApplicationDrafted","");
