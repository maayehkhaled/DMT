...
public class GetBillDataConfirmedBill extends Base {
    ...
    @Test(description = "GetBillDataConfirmedBill", priority = 1,
            retryAnalyzer = com.qpros.helpers.RetryAnalyzer.class, groups = {"API"})
    public void getBillDataConfirmedBill() throws JsonProcessingException {
        getData();
        verifyEligibility();
        getBill();
        cancelApp();
