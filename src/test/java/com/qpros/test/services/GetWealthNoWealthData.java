...
public class GetWealthNoWealthData extends Base {
    ...
    @Test(description = "Get Wealth No Wealth Data", priority = 1,
            retryAnalyzer = com.qpros.helpers.RetryAnalyzer.class, groups = {"API"})
    public void getWealthNoWealthData() throws JsonProcessingException {
        getData();
        verifyEligibility();
        getWealthItem();
        cancelApp();
    ...
    public void getData() {
        ...
        try {
            ...
            String[] nextLine;
            while ((nextLine = csvReader.readNext()) != null && count <= 76) {
                count++;
