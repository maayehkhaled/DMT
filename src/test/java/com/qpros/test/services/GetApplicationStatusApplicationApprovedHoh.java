...
public class GetApplicationStatusApplicationApprovedHoh extends Base {
    ...
    @Test(description = "GetApplicationStatusApplicationApprovedHoh", priority = 1,
            retryAnalyzer = com.qpros.helpers.RetryAnalyzer.class, groups = {"API"})
    public void GetApplicationStatusApplicationApprovedHoh() throws JsonProcessingException {
        getData();
        getGetApplicationStatusApplicationApprovedHoh();
        ...
        public void getGetApplicationStatusApplicationApprovedHoh() throws JsonProcessingException {
